...
{
private:
  UFC::TFixedFormat	FOrderFormat;
  UFC::TRenderData	FOrderRender;
  LeftQtyStore*     LStore;
  UFC::UiniFile     ErrMsgFile;
  UFC::PHashedList<UFC::AnsiString, TradeUnit*> FT32Table;
  void LoadT32( const UFC::AnsiString& IniPath );
  BOOL T32Check( const UFC::AnsiString& Symbol );
private:
  ///< For Stock
...
//  BOOL CheckLeftQty(UFC::AnsiString Account, UFC::AnsiString Symbol, Int32 SellQty, UFC::AnsiString InqType, UFC::AnsiString &Reason);
