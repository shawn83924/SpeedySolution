...
//---------------------------------------------------------------------------
TSpeedyFTPSendObject::TSpeedyFTPSendObject( const UFC::AnsiString& SourceID,
...
{
    if( TSpeedyFTPConnectionObject::ReceiveMessage( 1, mtL010 ) )
...
BOOL TSpeedyFTPSendObject::SendF050( TFtpJobObject* pJob )
{
    ...
    if( pJob->GetFileCode() == "R30" )
        MessageLength = 26;
    else if( pJob->GetFileCode() == "R40" )
        MessageLength = 26;
    else if( pJob->GetFileCode() == "R50" )
        MessageLength = 23;

    MessageF050 F050( (char*)(FSourceID.c_str()), (char*)(FDestinationID.c_str()), MessageLength, (char*)(pJob->GetFileCode().c_str()), pJob->GetStartSeq(), pJob->GetEndSeq() );
