...
# CC Compiler Flags
CCFLAGS=-m32 -std=c++11 -fPIC
CXXFLAGS=-m32 -std=c++11 -fPIC
...
${OBJECTDIR}/Exception.o: Exception.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Exception.o Exception.cpp

${OBJECTDIR}/Field.o: Field.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Field.o Field.cpp

${OBJECTDIR}/Record.o: Record.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Record.o Record.cpp

${OBJECTDIR}/Schema.o: Schema.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Schema.o Schema.cpp

${OBJECTDIR}/Table.o: Table.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Table.o Table.cpp
