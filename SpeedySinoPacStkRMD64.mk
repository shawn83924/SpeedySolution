...
#
	@echo
	@echo "                           SinoPac Dynamic Stock Risk Manager 64"
	@echo "==============================================================="
	cd SinoPacRiskManagerD && make CONF=LINUX_Release_64 
	@echo "==============================================================="
	@echo
#
	@echo
	@echo "                           Sino TAIFEX Risk Manager 64"
	@echo "==============================================================="
	cd SinoPacFuturesRiskManager && make CONF=LINUX_Release_64 
	@echo "==============================================================="
	@echo
all: default
...
#
	...
	@echo "                           SinoPac Dynamic Stock Risk Manager 64"
	@echo "==============================================================="
	cd SinoPacRiskManagerD && make CONF=LINUX_Release_64 clean
	@echo "==============================================================="
	@echo
#
	@echo
	@echo "                           Sino TAIFEX Risk Manager 64"
	@echo "==============================================================="
	cd SinoPacFuturesRiskManager && make CONF=LINUX_Release_64 clean 
	@echo "==============================================================="
	@echo
