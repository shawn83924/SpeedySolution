...
${OBJECTDIR}/SpeedyManager.o: SpeedyManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpeedyManager.o SpeedyManager.cpp

${OBJECTDIR}/UserDB.o: UserDB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserDB.o UserDB.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
