...
${OBJECTDIR}/WriteLog.o: WriteLog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g3 -gdwarf-2 -D__AIX -I../UFC -o ${OBJECTDIR}/WriteLog.o WriteLog.cpp

${OBJECTDIR}/CheckManager.o: CheckManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g3 -gdwarf-2 -D__AIX -I../UFC -o ${OBJECTDIR}/CheckManager.o CheckManager.cpp

${OBJECTDIR}/AccountStore.o: AccountStore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g3 -gdwarf-2 -D__AIX -I../UFC -o ${OBJECTDIR}/AccountStore.o AccountStore.cpp

${OBJECTDIR}/RiskManager.o: RiskManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g3 -gdwarf-2 -D__AIX -I../UFC -o ${OBJECTDIR}/RiskManager.o RiskManager.cpp
