...
#
	...
	@echo "                           SpeedyProxyCA"
	@echo "==============================================================="
	cd SpeedyProxy && make CONF=MLINKCA_LINUX_Release_64
	@echo "==============================================================="
	@echo
#
	@echo
...
#
	...
	@echo "                           MLTandemOrder"
	@echo "==============================================================="
	cd MLTandemOrder && make CONF=LINUX_Release
	@echo "==============================================================="
	@echo
#
	@echo
	@echo "                           MLTandemAdapter"
	@echo "==============================================================="
	cd MLTandemAdapter && make CONF=LINUX_Release
	@echo "==============================================================="
	@echo
#
	@echo
	@echo "                           MLExecConnection"
	@echo "==============================================================="
	cd COM/MLExecConnection && make CONF=LINUX_Release_64
	@echo "==============================================================="
	@echo
...
#
	...
	@echo "                           SpeedyProxyCA"
	@echo "==============================================================="
	cd SpeedyProxy && make CONF=MLINKCA_LINUX_Release_64 clean
	@echo "==============================================================="
	@echo
#
	@echo
...
#
	...
	@echo "                           MLTandemOrder"
	@echo "==============================================================="
	cd MLTandemOrder && make CONF=LINUX_Release clean
	@echo "==============================================================="
	@echo
#
	@echo
	@echo "                           MLTandemAdapter"
	@echo "==============================================================="
	cd MLTandemAdapter && make CONF=LINUX_Release clean
	@echo "==============================================================="
	@echo
#
	@echo
	@echo "                           MLExecConnection"
	@echo "==============================================================="
	cd COM/MLExecConnection && make CONF=LINUX_Release_64 clean
	@echo "==============================================================="
	@echo
