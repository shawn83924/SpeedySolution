...
LDLIBSOPTIONS=/MBus/lib/UFC.a /MBus/lib/TAIFEXLib.a
...
${OBJECTDIR}/SpeedyFTPRecvObject.o: SpeedyFTPRecvObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__AIX -I../UFC -I../Migo -o ${OBJECTDIR}/SpeedyFTPRecvObject.o SpeedyFTPRecvObject.cpp

${OBJECTDIR}/SpeedyMarketDataConnectionObject.o: SpeedyMarketDataConnectionObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__AIX -I../UFC -I../Migo -o ${OBJECTDIR}/SpeedyMarketDataConnectionObject.o SpeedyMarketDataConnectionObject.cpp

${OBJECTDIR}/SpeedyTMPOrderConnectionObject.o: SpeedyTMPOrderConnectionObject.cc 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__AIX -I../UFC -I../Migo -o ${OBJECTDIR}/SpeedyTMPOrderConnectionObject.o SpeedyTMPOrderConnectionObject.cc
...
${OBJECTDIR}/SpeedyFTPConnectionObject.o: SpeedyFTPConnectionObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__AIX -I../UFC -I../Migo -o ${OBJECTDIR}/SpeedyFTPConnectionObject.o SpeedyFTPConnectionObject.cpp
...
${OBJECTDIR}/SpeedyTMPOrderClient.o: SpeedyTMPOrderClient.cc 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__AIX -I../UFC -I../Migo -o ${OBJECTDIR}/SpeedyTMPOrderClient.o SpeedyTMPOrderClient.cc
...
${OBJECTDIR}/SpeedyFTPSendObject.o: SpeedyFTPSendObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__AIX -I../UFC -I../Migo -o ${OBJECTDIR}/SpeedyFTPSendObject.o SpeedyFTPSendObject.cpp
...
# Subprojects
.build-subprojects:
	cd ../TAIFEXLib && ${MAKE}  -f Makefile CONF=AIX_Release
...
# Subprojects
.clean-subprojects:
	cd ../TAIFEXLib && ${MAKE}  -f Makefile CONF=AIX_Release clean
