...
#
	@echo
	@echo "                     BrokerDataParser"
	@echo "==============================================================="
	cd BrokerDataParser && make CONF=LINUX_Tssco_Release_64
	@echo "==============================================================="
	@echo
#
	@echo
	@echo "                     Futures Risk Manager"
	@echo "==============================================================="
	cd FuturesRiskManager && make CONF=LINUX_Release_64
	@echo "==============================================================="
	@echo
...
#
	...
	@echo "                      BrokerDataParser"
	@echo "==============================================================="
	cd BrokerDataParser && make CONF=LINUX_Tssco_Release_64 clean
	@echo "==============================================================="
	@echo
#
	@echo
	@echo "                      Futures Risk Manager"
	@echo "==============================================================="
	cd FuturesRiskManager && make CONF=LINUX_Release_64 clean
	@echo "==============================================================="
	@echo
