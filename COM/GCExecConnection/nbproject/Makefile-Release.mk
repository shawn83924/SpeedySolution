...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /Speedy/bin/GCExecConnection

/Speedy/bin/GCExecConnection: ../Lib/./libSpeedyAPI.a

/Speedy/bin/GCExecConnection: /MBus/lib/libUFC.a

/Speedy/bin/GCExecConnection: ${OBJECTFILES}
	${MKDIR} -p /Speedy/bin
	${LINK.cc} -o /Speedy/bin/GCExecConnection ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} /Speedy/bin/GCExecConnection
