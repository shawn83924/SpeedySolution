...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /Speedy/bin/GCSRiskManager

/Speedy/bin/GCSRiskManager: ../Lib/./libSpeedyAPI.a

/Speedy/bin/GCSRiskManager: /MBus/lib/libUFC.a

/Speedy/bin/GCSRiskManager: ${OBJECTFILES}
	${MKDIR} -p /Speedy/bin
	${LINK.cc} -pthread -o /Speedy/bin/GCSRiskManager ${OBJECTFILES} ${LDLIBSOPTIONS} 
