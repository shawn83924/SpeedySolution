...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /Speedy/bin/GCSExecConnection

/Speedy/bin/GCSExecConnection: ../Lib/./libSpeedyAPI.a

/Speedy/bin/GCSExecConnection: /MBus/lib/libUFC.a

/Speedy/bin/GCSExecConnection: ${OBJECTFILES}
	${MKDIR} -p /Speedy/bin
	${LINK.cc} -o /Speedy/bin/GCSExecConnection ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} /Speedy/bin/GCSExecConnection
