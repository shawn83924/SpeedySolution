...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /Speedy/bin/KGIPTRM

/Speedy/bin/KGIPTRM: ../Lib/./libSpeedyAPI.a

/Speedy/bin/KGIPTRM: /MBus/lib/libUFC.a

/Speedy/bin/KGIPTRM: ${OBJECTFILES}
	${MKDIR} -p /Speedy/bin
	${LINK.cc} -pthread -o /Speedy/bin/KGIPTRM ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/KGIPTRM.o: KGIPTRM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__LINUX -I../OrderMessage -I../OrderConnection -I../../UFC -I../../Migo -I/usr/tibco/tibrv/include -o ${OBJECTDIR}/KGIPTRM.o KGIPTRM.cpp
