...
extern bool IsUseByProxy; // Chelsea 20260702
//---------------------------------------------------------------------------
...
const char *TTaifexConnection::GetExchangePositionEffect(nsOrderMessageDefine::PositionEffectEnum pe)
{
    ...
    case nsOrderMessageDefine::peAutoToday:
        return "5";
    case nsOrderMessageDefine::peForceClose:
        return "7";
...
void TTaifexConnection::FillOrderBase(nsOrderMessageDefine::TradingSessionIDEnum TradingSession, nsOrderMessageDefine::MarketEnum Market, TBaseMessage *Msg, UFC::TRenderData *R010Render)
{
    ...
    if (Market == nsOrderMessageDefine::mTSE || Market == nsOrderMessageDefine::mOTC || Market == nsOrderMessageDefine::mES)
    {
        ...
        case nsOrderMessageDefine::tifROD:
            R010Render->SetField("TimeInForce", "0");
            break;
        case nsOrderMessageDefine::tifIOC:
            R010Render->SetField("TimeInForce", "3");
            break;
        case nsOrderMessageDefine::tifFOK:
            R010Render->SetField("TimeInForce", "4");
            break;
        default:
            R010Render->SetField("TimeInForce", "0");
            break;
    ...
    else
    {
        ...
        {
        case nsOrderMessageDefine::tifROD:
            R010Render->SetField("TimeInForce", "R");
            break;
        case nsOrderMessageDefine::tifIOC:
            R010Render->SetField("TimeInForce", "I");
            break;
        case nsOrderMessageDefine::tifFOK:
            R010Render->SetField("TimeInForce", "F");
            break;
        default:
            R010Render->SetField("TimeInForce", "R");
            break;
...
void TTaifexConnection::FillPATSOrderBase(TBaseMessage *Msg, UFC::NameValueMessage *PATSMessage)
{
    ...
    if (BrokerID.Length() > 0)
        PATSMessage->Append("fcm", BrokerID);
    ...
    case nsOrderMessageDefine::otMarketWithProtection:
        orderTypeStr = "MWP";
        break;
    case nsOrderMessageDefine::otMarketOnClose:
        orderTypeStr = "MOC";
        break;
    case nsOrderMessageDefine::otLimitOnClose:
        orderTypeStr = "LOC";
        break;
    ...
    if (MsgType == nsOrderMessageDefine::mtCancel)
    {
        ...
        if (orderTypeStr.Length() > 0)
            PATSMessage->Append("ooty", orderTypeStr);
    }
    ...
    {
    case nsOrderMessageDefine::peOpen:
        PATSMessage->Append("pe", "O");
        break;
    case nsOrderMessageDefine::peClose:
        PATSMessage->Append("pe", "C");
        break;
    case nsOrderMessageDefine::peDayTrade:
        PATSMessage->Append("pe", "D");
        break;
    case nsOrderMessageDefine::peDayTradeOpen:
        PATSMessage->Append("pe", "d");
        break;
    case nsOrderMessageDefine::peAutoToday:
        PATSMessage->Append("pe", "a");
        break;
    case nsOrderMessageDefine::peAuto:
        PATSMessage->Append("pe", "A");
        break;
    ...
    if (MaturityMonthYear.Length() > 0)
        PATSMessage->Append("mmy", MaturityMonthYear);
    ...
    if (localIP.Length() > 0)
        PATSMessage->Append("lip", localIP);
    if (orderChannel.Length() > 0)
        PATSMessage->Append("och", orderChannel);
...
void TTaifexConnection::FillChinaOrderBase(TBaseMessage *Msg, UFC::NameValueMessage *GLQHMessage)
{
    ...
    if ((oNewOrder = dynamic_cast<TNewOrderMessage *>(Msg)) != NULL)
    {
        ...
        {
        case nsOrderMessageDefine::tifROD:
            GLQHMessage->Append("tif", "R");
            break;
        case nsOrderMessageDefine::tifIOC:
            GLQHMessage->Append("tif", "I");
            break;
        case nsOrderMessageDefine::tifFOK:
            GLQHMessage->Append("tif", "F");
            break;
        default:
            GLQHMessage->Append("tif", "R");
            break;
...
bool TTaifexConnection::SupportSellSide(TBaseMessage *Msg)
{
    ...
    case nsOrderMessageDefine::mTSE:
    case nsOrderMessageDefine::mES:
        IsSupport = FSupportSellSide.Exists(ssTSEOTC);
        break;
    case nsOrderMessageDefine::mTWFutures:
    case nsOrderMessageDefine::mTWOptions:
        IsSupport = FSupportSellSide.Exists(ssTAIFEX);
        break;
    case nsOrderMessageDefine::mForeignStock:
    case nsOrderMessageDefine::mForeignFutures:
    case nsOrderMessageDefine::mForeignOptions:
        IsSupport = FSupportSellSide.Exists(ssForeignExchange);
        break;
    default:
        IsSupport = false;
        break;
...
void TTaifexConnection::NewOrder(TNewOrderMessage *Msg)
{
    ...
    if (FUseAPI == atSpeedy)
    {
        ...
        else ///< Speedy API
        {
            ...
            case nsOrderMessageDefine::mTSE:
            case nsOrderMessageDefine::mES:
                RenderOK = RenderTSEOTCNewOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mCNFutures:
            case nsOrderMessageDefine::mCNOptions:
                RenderOK = RenderChinaNewOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mForeignStock:
            case nsOrderMessageDefine::mForeignFutures:
            case nsOrderMessageDefine::mForeignOptions:
                RenderOK = RenderForeignNewOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mTWFutures: ///< Check FLEX Symbol
            case nsOrderMessageDefine::mTWOptions:
                if (CheckFLEXSymbol(TestSymbol) == false)
                {
                ...
                break;
            case nsOrderMessageDefine::mUnknown:
                RenderOK = false;
                break;
            }
            if (!RenderOK)
...
void TTaifexConnection::CancelOrder(TCancelOrderMessage *Msg)
{
    ...
    if (FUseAPI == atSpeedy)
    {
        ...
        else
        {
            ...
            case nsOrderMessageDefine::mTSE:
            case nsOrderMessageDefine::mES:
                RenderOK = RenderTSEOTCCancelOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mTWFutures:
            case nsOrderMessageDefine::mTWOptions:
                RenderOK = RenderTAIFEXCancelOrder(Msg, R010, Source);
                break;
            case nsOrderMessageDefine::mCNFutures:
            case nsOrderMessageDefine::mCNOptions:
                RenderOK = RenderChinaCancelOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mForeignStock:
            case nsOrderMessageDefine::mForeignFutures:
            case nsOrderMessageDefine::mForeignOptions:
                RenderOK = RenderForeignCancelOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mUnknown:
                RenderOK = false;
                break;
...
void TTaifexConnection::ReplaceOrder(TReplaceOrderMessage *Msg)
{
    ...
    if (FUseAPI == atSpeedy)
    {
        ...
        else
        {
            ...
            case nsOrderMessageDefine::mTSE:
            case nsOrderMessageDefine::mES:
                RenderOK = RenderTSEOTCReplaceOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mTWFutures:
            case nsOrderMessageDefine::mTWOptions:
                RenderOK = RenderTAIFEXReplaceOrder(Msg, R010, Source);
                break;
            case nsOrderMessageDefine::mCNFutures:
            case nsOrderMessageDefine::mCNOptions:
                RenderOK = RenderChinaReplaceOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mForeignStock:
            case nsOrderMessageDefine::mForeignFutures:
            case nsOrderMessageDefine::mForeignOptions:
                RenderOK = RenderForeignReplaceOrder(Msg, R010);
                break;
            case nsOrderMessageDefine::mUnknown:
                RenderOK = false;
                break;
...
void TTaifexConnection::OrderStatusRequest(TOrderStatusRequest *Msg)
{
    ...
    if (FUseAPI == atSpeedy)
    {
        ...
        else
        {
            ...
            case nsOrderMessageDefine::mOTC:
            case nsOrderMessageDefine::mTSE:
                RenderOK = RenderTSEOTCOrderStatus(Msg, R010);
                break;
            case nsOrderMessageDefine::mTWFutures:
            case nsOrderMessageDefine::mTWOptions:
                RenderOK = RenderTAIFEXOrderStatus(Msg, R010, Source);
                break;
            case nsOrderMessageDefine::mCNFutures:
            case nsOrderMessageDefine::mCNOptions:
            case nsOrderMessageDefine::mForeignStock:
...
int TTaifexConnection::SendNewsRequest(const UFC::AnsiString &FuncStr, const UFC::AnsiString &DataStr, int Count, int index)
{
    ...
    FRequestEvent->ResetEvent(); ///< Old-UID replies are rejected from here on; clear stale triggers before sending.
...
bool TTaifexConnection::MarginPositionRequest(const UFC::AnsiString &BrokerID, const UFC::AnsiString &Account, UFC::AnsiString &Result)
{
    ...
    ///< Serialize concurrent requests; FLastReqUID/FResponseData are shared per connection.
    UFC::PLockObject Lock(FNewsRequestCS);

    ///< Send Request to SpeedyGataway
    DataStr.Printf("%s,%s", BrokerID.c_str(), Account.c_str());
    SendNewsRequest("ReqFUTMargin", DataStr, 0, 0); ///< Resets FRequestEvent internally before sending.

    ///< Wait for Response; drop stale replies of earlier requests.
    Int32 BeginMS = (Int32)UFC::GetTickCountMS();
    Int32 WaitMS = 5000;

    while (FRequestEvent->WaitFor(0, WaitMS) == true)
    {
        if (FResponseUID == FLastReqUID)
        {
        ...
        WaitMS = 5000 - ((Int32)UFC::GetTickCountMS() - BeginMS);
        if (WaitMS <= 0)
            break;
    }
                                   ...
                                   int Group)
{
    ...
    {
    case nsOrderMessageDefine::mTWFutures:
        MBusClient->BeginSend(MHandle, SUBJECT_ORDER_FUT, PublishKey);
        break;
    case nsOrderMessageDefine::mTWOptions:
        MBusClient->BeginSend(MHandle, SUBJECT_ORDER_OPT, PublishKey);
        break;
    case nsOrderMessageDefine::mTSE:
        MBusClient->BeginSend(MHandle, SUBJECT_ORDER_TSE, PublishKey);
        break;
    case nsOrderMessageDefine::mOTC:
        MBusClient->BeginSend(MHandle, SUBJECT_ORDER_OTC, PublishKey);
        break;
    case nsOrderMessageDefine::mES:
        MBusClient->BeginSend(MHandle, SUBJECT_ORDER_ES, PublishKey);
        break;
    case nsOrderMessageDefine::mForeignStock:
        MBusClient->BeginSend(MHandle, SUBJECT_ORDER_FOREIGN_STK, PublishKey);
        break;
    case nsOrderMessageDefine::mForeignFutures:
        MBusClient->BeginSend(MHandle, SUBJECT_ORDER_FOREIGN_FUT, PublishKey);
        break;
    case nsOrderMessageDefine::mForeignOptions:
        MBusClient->BeginSend(MHandle, SUBJECT_ORDER_FOREIGN_OPT, PublishKey);
        break;
    default:
        return false;
    }
