// REPLACEORDERMESSAGEIMPL.H : Declaration of the TReplaceOrderMessageImpl

#ifndef ReplaceOrderMessageImplH
#define ReplaceOrderMessageImplH
...
/////////////////////////////////////////////////////////////////////////////
// TReplaceOrderMessageImpl     Implements IReplaceOrderMessage, default interface of ReplaceOrderMessage
// ThreadingModel : Apartment
// Dual Interface : TRUE
// Event Support  : FALSE
// Default ProgID : OrderMessage.ReplaceOrderMessage
// Description    : 
/////////////////////////////////////////////////////////////////////////////
class ATL_NO_VTABLE TReplaceOrderMessageImpl : 
  public CComObjectRootEx<CComSingleThreadModel>,
  public CComCoClass<TReplaceOrderMessageImpl, &CLSID_ReplaceOrderMessage>,
  public IDispatchImpl<IReplaceOrderMessage, &IID_IReplaceOrderMessage, &LIBID_OrderMessage>
{
private:
    TReplaceOrderMessage FMessage;
...
public:
  ...
  DECLARE_PROGID("OrderMessage.ReplaceOrderMessage");
  DECLARE_DESCRIPTION("");
  ...
  {
	TTypedComServerRegistrarT<TReplaceOrderMessageImpl>
	regObj(GetObjectCLSID(), GetProgID(), GetDescription());
	return regObj.UpdateRegistry(bRegister);
  }


BEGIN_COM_MAP(TReplaceOrderMessageImpl)
  COM_INTERFACE_ENTRY(IReplaceOrderMessage)
  COM_INTERFACE_ENTRY2(IDispatch, IReplaceOrderMessage)
END_COM_MAP()
...
#endif //ReplaceOrderMessageImplH
