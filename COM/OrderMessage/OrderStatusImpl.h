...
#ifndef OrderStatusImplH
#define OrderStatusImplH
...
public:
  ...
  STDMETHOD(set_NID(long Value));
  STDMETHOD(set_Symbol(BSTR Value));
  STDMETHOD(GetValue(BSTR Name, BSTR* Value));
  STDMETHOD(SetValue(BSTR Name, BSTR Value));
