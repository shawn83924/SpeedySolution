// ---------------------------------------------------------------------------
// ORDERSTATUSREQUESTIMPL : Implementation of TOrderStatusRequestImpl (CoClass: OrderStatusRequest, Interface: IOrderStatusRequest)
// ---------------------------------------------------------------------------
#include <vcl.h>
#pragma hdrstop
...
// ---------------------------------------------------------------------------
__fastcall TOrderStatusRequestMessageImpl::TOrderStatusRequestMessageImpl()
{
}
// ---------------------------------------------------------------------------
// TOrderStatusRequestImpl
// ---------------------------------------------------------------------------
__fastcall TOrderStatusRequestMessageImpl::TOrderStatusRequestMessageImpl(const System::_di_IInterface Controller)
...
// TOrderStatusRequestImpl
// ---------------------------------------------------------------------------
__fastcall TOrderStatusRequestMessageImpl::TOrderStatusRequestMessageImpl(Comobj::TComObjectFactory* Factory,
									  const System::_di_IInterface Controller)
							  : inherited(Factory, Controller)
{
}
// ---------------------------------------------------------------------------
// TOrderStatusRequestImpl - Class Factory
// ---------------------------------------------------------------------------
static void createFactory()
{
  new TCppAutoObjectFactory<TOrderStatusRequestMessageImpl>(Comserv::GetComServer(),
						   __classid(TOrderStatusRequestMessageImpl),
						   CLSID_OrderStatusRequestMessage,
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::get_NID(__int64* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::set_NID(__int64 Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::get_Value(BSTR Name, BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::set_Value(BSTR Name, BSTR Value)
{
	AnsiString ValName( Name );
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::get_AccountFlag(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::set_AccountFlag(BSTR Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::get_GatewayData(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::set_GatewayData(BSTR Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::get_TradingSessionID(TradingSessionIDEnum* Value)
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::set_TradingSessionID(TradingSessionIDEnum Value)
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::get_BrokerID(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::set_BrokerID(BSTR Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::get_ExchangeCode(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TOrderStatusRequestMessageImpl::set_ExchangeCode(BSTR Value)
{
	AnsiString ExchangeCode( Value );
