...
// ---------------------------------------------------------------------------
__fastcall TCancelOrderMessageImpl::TCancelOrderMessageImpl()
{
}
// ---------------------------------------------------------------------------
// TCancelOrderMessageImpl
// ---------------------------------------------------------------------------
__fastcall TCancelOrderMessageImpl::TCancelOrderMessageImpl(const System::_di_IInterface Controller)
...
// TCancelOrderMessageImpl
// ---------------------------------------------------------------------------
__fastcall TCancelOrderMessageImpl::TCancelOrderMessageImpl(Comobj::TComObjectFactory* Factory,
									  const System::_di_IInterface Controller)
							  : inherited(Factory, Controller)
{
}
// ---------------------------------------------------------------------------
// TCancelOrderMessageImpl - Class Factory
// ---------------------------------------------------------------------------
static void createFactory()
{
  new TCppAutoObjectFactory<TCancelOrderMessageImpl>(Comserv::GetComServer(),
						   __classid(TCancelOrderMessageImpl),
						   CLSID_CancelOrderMessage,
...
//------------------------------------------------------------------------------
STDMETHODIMP TCancelOrderMessageImpl::get_CancelNID(__int64* Value)
{
	*Value = FMessage.GetCNID();
	return S_OK;
};
//------------------------------------------------------------------------------
STDMETHODIMP TCancelOrderMessageImpl::set_CancelNID(__int64 Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TCancelOrderMessageImpl::get_Src(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TCancelOrderMessageImpl::set_Src(BSTR Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TCancelOrderMessageImpl::get_LocalIP(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TCancelOrderMessageImpl::set_LocalIP(BSTR Value)
{
...
STDMETHODIMP TCancelOrderMessageImpl::get_CASignature(BSTR* Value)
{
...
STDMETHODIMP TCancelOrderMessageImpl::set_CASignature(BSTR Value)
{
...
STDMETHODIMP TCancelOrderMessageImpl::get_CAPlainText(BSTR* Value)
{
...
STDMETHODIMP TCancelOrderMessageImpl::set_CAPlainText(BSTR Value)
{
...
STDMETHODIMP TCancelOrderMessageImpl::get_CASessionID(BSTR* Value)
{
...
STDMETHODIMP TCancelOrderMessageImpl::set_CASessionID(BSTR Value)
{
