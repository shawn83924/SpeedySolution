...
// TQuoteMessageImpl
// ---------------------------------------------------------------------------
__fastcall TQuoteMessageImpl::TQuoteMessageImpl()
{
}
// ---------------------------------------------------------------------------
// TQuoteMessageImpl
// ---------------------------------------------------------------------------
__fastcall TQuoteMessageImpl::TQuoteMessageImpl(const System::_di_IInterface Controller)
...
// TQuoteMessageImpl
// ---------------------------------------------------------------------------
__fastcall TQuoteMessageImpl::TQuoteMessageImpl(Comobj::TComObjectFactory* Factory,
									  const System::_di_IInterface Controller)
							  : inherited(Factory, Controller)
{
}
// ---------------------------------------------------------------------------
// TQuoteMessageImpl - Class Factory
// ---------------------------------------------------------------------------
static void createFactory()
{
  new TCppAutoObjectFactory<TQuoteMessageImpl>(Comserv::GetComServer(),
						   __classid(TQuoteMessageImpl),
						   CLSID_QuoteMessage,
...
//------------------------------------------------------------------------------
STDMETHODIMP TQuoteMessageImpl::get_TradingSessionID(TradingSessionIDEnum* Value)
...
//------------------------------------------------------------------------------
STDMETHODIMP TQuoteMessageImpl::set_TradingSessionID(TradingSessionIDEnum Value)
{
