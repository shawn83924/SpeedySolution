...
// ---------------------------------------------------------------------------
__fastcall TNewOrderMessageImpl::TNewOrderMessageImpl()
{
}
// ---------------------------------------------------------------------------
// TNewOrderMessageImpl
// ---------------------------------------------------------------------------
__fastcall TNewOrderMessageImpl::TNewOrderMessageImpl(const System::_di_IInterface Controller)
...
// TNewOrderMessageImpl
// ---------------------------------------------------------------------------
__fastcall TNewOrderMessageImpl::TNewOrderMessageImpl(Comobj::TComObjectFactory* Factory,
									  const System::_di_IInterface Controller)
: inherited(Factory, Controller)
{
}
// ---------------------------------------------------------------------------
// TNewOrderMessageImpl - Class Factory
// ---------------------------------------------------------------------------
static void createFactory()
{
  new TCppAutoObjectFactory<TNewOrderMessageImpl>(Comserv::GetComServer(),
                           __classid(TNewOrderMessageImpl),
                           CLSID_NewOrderMessage,
...
//------------------------------------------------------------------------------
STDMETHODIMP TNewOrderMessageImpl::get_Src(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TNewOrderMessageImpl::set_Src(BSTR Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TNewOrderMessageImpl::get_LocalIP(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TNewOrderMessageImpl::set_LocalIP(BSTR Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TNewOrderMessageImpl::get_ExpireDate(BSTR* Value)
{
...
//------------------------------------------------------------------------------
STDMETHODIMP TNewOrderMessageImpl::set_ExpireDate(BSTR Value)
{
...
STDMETHODIMP TNewOrderMessageImpl::get_CASessionID(BSTR* Value)
{
...
STDMETHODIMP TNewOrderMessageImpl::set_CASessionID(BSTR Value)
{
...
STDMETHODIMP TNewOrderMessageImpl::get_CAPlainText(BSTR* Value)
{
...
STDMETHODIMP TNewOrderMessageImpl::set_CAPlainText(BSTR Value)
{
...
STDMETHODIMP TNewOrderMessageImpl::get_CASignature(BSTR* Value)
{
...
STDMETHODIMP TNewOrderMessageImpl::set_CASignature(BSTR Value)
{
