...
// Dual Interface : TRUE
// Event Support  : FALSE
// Description    : Message to replace an order
// ---------------------------------------------------------------------------
class DAX_COM_CLASS TReplaceOrderMessageImpl : public TCppAutoObject<IReplaceOrderMessage>
{
  typedef _COM_CLASS inherited;
private:
    TReplaceOrderMessage FMessage;
public:
  __fastcall TReplaceOrderMessageImpl();
  __fastcall TReplaceOrderMessageImpl(const System::_di_IInterface Controller);
  __fastcall TReplaceOrderMessageImpl(Comobj::TComObjectFactory* Factory, const System::_di_IInterface Controller);
