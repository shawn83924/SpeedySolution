...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/LINUX_Release_64/GNU-Linux-x86/SpeedyOrderConnection

dist/LINUX_Release_64/GNU-Linux-x86/SpeedyOrderConnection: /MBus/lib/libSpeedyAPI_64.a

dist/LINUX_Release_64/GNU-Linux-x86/SpeedyOrderConnection: /MBus/lib/libUFC_64.a

dist/LINUX_Release_64/GNU-Linux-x86/SpeedyOrderConnection: ${OBJECTFILES}
	${MKDIR} -p dist/LINUX_Release_64/GNU-Linux-x86
	${LINK.cc} -o dist/LINUX_Release_64/GNU-Linux-x86/SpeedyOrderConnection ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread -lrt
