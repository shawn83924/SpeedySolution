...
/Speedy/bin/CapitalExecConnection: ${OBJECTFILES}
	${MKDIR} -p /Speedy/bin
	g++ -o /Speedy/bin/CapitalExecConnection ${OBJECTFILES} ${LDLIBSOPTIONS} -pthreads

${OBJECTDIR}/CaptialExecConnection.o: CaptialExecConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -I../../UFC -I../../Migo -I../Lib -I../Lib/OrderConnection -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CaptialExecConnection.o CaptialExecConnection.cpp

${OBJECTDIR}/Main.o: Main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -I../../UFC -I../../Migo -I../Lib -I../Lib/OrderConnection -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Main.o Main.cpp

${OBJECTDIR}/TUserData.o: TUserData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -I../../UFC -I../../Migo -I../Lib -I../Lib/OrderConnection -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TUserData.o TUserData.cpp

# Subprojects
.build-subprojects:
	cd ../Lib && ${MAKE}  -f Makefile CONF=Solaris_Release
...
# Subprojects
.clean-subprojects:
	cd ../Lib && ${MAKE}  -f Makefile CONF=Solaris_Release clean
