...
${OBJECTDIR}/CaptialExecConnection.o: CaptialExecConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__LINUX -I../../UFC -I../../Migo -I../Lib -I../Lib/OrderConnection -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CaptialExecConnection.o CaptialExecConnection.cpp

${OBJECTDIR}/Main.o: Main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__LINUX -I../../UFC -I../../Migo -I../Lib -I../Lib/OrderConnection -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Main.o Main.cpp

${OBJECTDIR}/TUserData.o: TUserData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__LINUX -I../../UFC -I../../Migo -I../Lib -I../Lib/OrderConnection -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TUserData.o TUserData.cpp
