...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} dist/Debug/GNU-Generic/speedyfiforiskmanager

dist/Debug/GNU-Generic/speedyfiforiskmanager: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Generic
	${LINK.cc} -o dist/Debug/GNU-Generic/speedyfiforiskmanager ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/SpeedyFIFORiskManager.o: SpeedyFIFORiskManager.cc 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g3 -gdwarf-2 -o ${OBJECTDIR}/SpeedyFIFORiskManager.o SpeedyFIFORiskManager.cc
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Generic/speedyfiforiskmanager
