...
# CC Compiler Flags
CCFLAGS=-pthread -Wno-deprecated
CXXFLAGS=-pthread -Wno-deprecated
...
LDLIBSOPTIONS=/MBus/lib/libSpeedyAPI.a ../../UFC/../bin/libUFC.a
...
/Speedy/bin/MegaOrderConnection: ${OBJECTFILES}
	${MKDIR} -p /Speedy/bin
	${LINK.cc} -pthread -Wno-deprecated -o /Speedy/bin/MegaOrderConnection ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} /Speedy/bin/MegaOrderConnection
