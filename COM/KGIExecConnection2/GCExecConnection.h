...
public:
    ...
    UFC::AnsiString Qty;
public:
    QuoteInfo( const UFC::AnsiString& px, const UFC::AnsiString& q )
    :Price( px ), Qty( q ) {}    
};
...
private:
    ...
    UFC::AnsiString FConfirmRODKey;
    UFC::AnsiString FFillSubject;
    UFC::AnsiString FFillKey;
    UFC::AnsiString FFillRODKey;
...
private:
    ...
    UFC::PHashedList<UFC::AnsiString, QuoteInfo*> FQuoteTable;
...
public: ///< Implement for GC execution
    void ConfirmToBackend( TExecutionReportMessage* Msg );
    void FillToBackend( TExecutionReportMessage* Msg );
public: ///< Implement for KGI execution
    void KGIConfirmToBackend( TExecutionReportMessage* Msg, BOOL IsQuote = FALSE );
    void KGIFillToBackend( TExecutionReportMessage* Msg );
private:
...
public:
    ...
    void Recover( UFC::AnsiString BeginTime, char Type, char EType );    
};
//------------------------------------------------------------------------------
#endif
