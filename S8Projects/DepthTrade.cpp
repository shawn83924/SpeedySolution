...
///< Buy side color
TColor BidDepth5BKColor[2]       = {clWhite,clBlack};
TColor BidDepth5Color[2]         = {RGB(248,152,154),RGB(255,166,166)};
TColor BuyBKColor[2]             = {clWhite,clBlack};
TColor BuyColor[2]               = {clBlack,clWhite};
TColor BuyDelBKColor[2]          = {clWhite,clBlack};
TColor BuyFillBKColor[2]         = {clWhite,clBlack};
TColor BuyFillColor[2]           = {clBlack,clWhite};
TColor BuyConditionColBKColor[2] = {clWhite,clBlack};
TColor BuyConditionColColor[2]   = {clBlack,clWhite};
TColor BuyOCOColBKColor[2]       = {clWhite,clBlack};
TColor BuyOCOColColor[2]         = {clBlack,clWhite};
TColor BuyOCODelColBKColor[2]    = {clWhite,clBlack};
///<Sell side color
TColor AskDepth5BKColor[2]        = {clWhite,clBlack};
TColor AskDepth5Color[2]          = {RGB(124,186,63),RGB(149,255,116)};
TColor SellBKColor[2]             = {clWhite,clBlack};
TColor SellColor[2]               = {clBlack,clWhite};
TColor SellDelBKColor[2]          = {clWhite,clBlack};
TColor SellFillBKColor[2]         = {clWhite,clBlack};
TColor SellFillColor[2]           = {clBlack,clWhite};
TColor SellConditionColBKColor[2] = {clWhite,clBlack};
TColor SellConditionColColor[2]   = {clBlack,clWhite};
TColor SellOCOColBKColor[2]       = {clWhite,clBlack};
TColor SellOCOColColor[2]         = {clBlack,clWhite};
TColor SellOCODelColBKColor[2]    = {clWhite,clBlack};
//---------------------------------------------------------------------------
