...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MessageL030::MessageL030( int AppNo )
:MessageHeader("10","20","02")
{
    char TmpStr[ 4 ];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MessageL030::MessageL030( char* Data )
:MessageHeader( Data )
{
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MessageL040::MessageL040(  char* AppendNumber, char* Broker, char AP, char* Password )
:MessageHeader("10","20","03"),APCode( AP )
{
	char KeyValueStr[ 8 ];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MessageL040::MessageL040( char* Data )
:MessageHeader( Data )
{
...
void MessageL040::print( void )
{
	...
	SocketPrintf("[ Broker ID %s ]\n",UFC::AnsiString( BrokerID, 7 ).c_str());
...
{
	UFC::AnsiString RtnStr(BrokerID,7);
	return RtnStr;
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
