...
{
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
TMessageType MessageHeader::GetAuctionTransactionSubsystemMessage( int FuncCode, int MsgType )
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MessageA010::MessageA010( char* FunctionCode,char* Body )
:MessageHeader("70",FunctionCode,"00")
{
    LoadBody( Body );
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MessageA010::MessageA010( const char* Buffer )
:MessageHeader( Buffer )
{
    LoadBody( Buffer  + MESSAGE_HEADER_SIZE );
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA010::LoadBody( const char *Body )
{
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA010::AsString( char* Buffer )
{
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
double MessageA010::GetOrderPrice( void )
{
    return ((double)UFC::AnsiString::StrToInt32( OrderPrice, 9 ))/10000.0;    
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Int64 MessageA010::GetOrderQty( void )
{
    UFC::AnsiString Qty( OrderQty, 12 );
    return  Qty.ToInt64();
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA010::print( void )
{
    SocketPrintf("---------------------- Order message A010 ---------------------\n" );
    ...
    SocketPrintf("-------------------------- End of A010 ------------------------\n");
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//  Class MessageA020
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MessageA020::MessageA020( const char *Data )
:MessageHeader( Data )
{
    LoadBody( Data + MESSAGE_HEADER_SIZE );
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MessageA020::MessageA020( char* Func, char *Body )
:MessageHeader( "70",Func,"01" )
{
    LoadBody( Body );
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA020::LoadBody( const char *Body )
{
    MemoryStreamReader MemReader( Body );
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA020::AsString( char* Buffer )
{
    MessageHeader::AsString( Buffer );
    MemoryStreamWriter MemWriter( Buffer + MESSAGE_HEADER_SIZE );
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA020::SetPrice( double Px )
{
    char buffer[16];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA020::SetQty( Int64 Qty )
{
    char buffer[16];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA020::SetBeforeQty( Int64 Qty )
{
    char buffer[16];
    snprintf( buffer, 13, "%012lld", Qty );
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA020::SetAfterQty( Int64 Qty )
{
    char buffer[16];
    snprintf( buffer, 13, "%012lld", Qty );
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA020::SetDate( int YYYY, int MM, int DD )
{
    char buffer[16];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA020::SetTime( int H, int M, int S, int mmm )
{
    char buffer[16];
...
//---------------------------------------------------------------------------
void MessageA020::print( void )
{
    SocketPrintf("--------------- Accept order report mesage A020 ---------------\n" );
    ...
    SocketPrintf("----------------------- End of A020 ---------------------------\n");
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void MessageA030::print( void )
{
    char TmpStr[3];
    strncpynt( TmpStr, GetStatusCodeStr(), 2 );
    SocketPrintf("----- Error Order message A030 code: %s -----------------\n",TmpStr );
}
//-----------------------------------------------------------------------------------------
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
