...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} /MBus/lib/TSECLib.a
...
${OBJECTDIR}/MessageHeader.o: MessageHeader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/MessageHeader.o MessageHeader.cpp

${OBJECTDIR}/SocketConnection.o: SocketConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/SocketConnection.o SocketConnection.cpp

${OBJECTDIR}/IBMX25Connection.o: IBMX25Connection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/IBMX25Connection.o IBMX25Connection.cpp

${OBJECTDIR}/EMessages.o: EMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/EMessages.o EMessages.cpp

${OBJECTDIR}/TMessages.o: TMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/TMessages.o TMessages.cpp

${OBJECTDIR}/FMessages.o: FMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/FMessages.o FMessages.cpp
...
${OBJECTDIR}/_ext/space/src/SpeedySolution/Simulator/TSECLib/../ExchangeUtility/Utility.o: ../ExchangeUtility/Utility.cpp 
	...
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/_ext/space/src/SpeedySolution/Simulator/TSECLib/../ExchangeUtility/Utility.o ../ExchangeUtility/Utility.cpp

${OBJECTDIR}/SUNX25Connection.o: SUNX25Connection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/SUNX25Connection.o SUNX25Connection.cpp

${OBJECTDIR}/LMessages.o: LMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/LMessages.o LMessages.cpp

${OBJECTDIR}/VMessages.o: VMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/VMessages.o VMessages.cpp

${OBJECTDIR}/ExchangeConst.o: ExchangeConst.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/ExchangeConst.o ExchangeConst.cpp

${OBJECTDIR}/AMessages.o: AMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/AMessages.o AMessages.cpp
...
${OBJECTDIR}/_ext/home/yuan/src/SpeedySolution/Simulator/TSECLib/ExMessages.o: /home/yuan/src/SpeedySolution/Simulator/TSECLib/ExMessages.cpp 
	...
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/_ext/home/yuan/src/SpeedySolution/Simulator/TSECLib/ExMessages.o /home/yuan/src/SpeedySolution/Simulator/TSECLib/ExMessages.cpp

${OBJECTDIR}/LinkSubSystem.o: LinkSubSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/LinkSubSystem.o LinkSubSystem.cpp

${OBJECTDIR}/SMessages.o: SMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/SMessages.o SMessages.cpp

${OBJECTDIR}/PMessages.o: PMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/PMessages.o PMessages.cpp

${OBJECTDIR}/RMessages.o: RMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/RMessages.o RMessages.cpp

${OBJECTDIR}/OMessages.o: OMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -D__SOLARIS -o ${OBJECTDIR}/OMessages.o OMessages.cpp
