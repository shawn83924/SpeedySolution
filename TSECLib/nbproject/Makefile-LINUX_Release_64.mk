...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /MBus/lib/TSECLib_64.a

/MBus/lib/TSECLib_64.a: ${OBJECTFILES}
	${MKDIR} -p /MBus/lib
	${RM} /MBus/lib/TSECLib_64.a
	${AR} -rv /MBus/lib/TSECLib_64.a ${OBJECTFILES} 
	$(RANLIB) /MBus/lib/TSECLib_64.a
